...
/***/ function(module, exports, __webpack_require__) {
	...
	function update() {
	  render((0, _deku.element)(_Search2.default, { items: items,
	    ...
	    maxSelected: 3,
	    multiple: true,
	    onItemsChanged: function onItemsChanged(items) {
	      return HiItems(items);
	    } }), {});
	}
	...
	function render(_ref2) {
	  ...
	  function renderMenuItems() {
	    if (!menuItems.length) {
	      ...
	      return (0, _deku.element)('li', { 'class': 'autocomplete__item autocomplete__item--disabled' }, (0, _deku.element)('span', { 'data-id': 0 }, notFound));
	    }
	
	    var items = menuItems.map(function (item, i) {
	      if (itemSelected(item.id)) {
	        return (0, _deku.element)('li', { key: i, 'class': 'autocomplete__item autocomplete__item--disabled' }, (0, _deku.element)('span', { key: i, 'data-id': item.id, innerHTML: item.value }));
	      } else {
	        return (0, _deku.element)('li', { key: i, 'class': 'autocomplete__item', onClick: function onClick(e) {
	            return handleSelect(e);
	          } }, (0, _deku.element)('span', { key: i, 'data-id': item.id }, item.value));
	      }
	    });
	    return items;
	  }
	  ...
	  function renderSelectedItems() {
	    ...
	    if (!selectedItems.length && !multiple) {
	      return (0, _deku.element)('li', { 'class': 'autocomplete__item autocomplete__item--selected autocomplete__item__dropdown',
	        ...
	        } }, (0, _deku.element)('span', { innerHTML: placeholder }), (0, _deku.element)('span', { 'class': 'autocomplete__dropdown' }));
	    }
	    ...
	    var items = selectedItems.map(function (item, i) {
	      ...
	      return (0, _deku.element)('li', { key: i, 'class': itemClass, onClick: function onClick(e) {
	          return handleItemClick(e);
	        } }, (0, _deku.element)('span', { 'data-id': item.id, innerHTML: item.value }), icon, dropDown);
	    });
	    return items;
	  }
